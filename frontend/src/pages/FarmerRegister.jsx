...
function FarmerRegister() {
  ...
  const registerUser = useAuthStore((state) => state.FarmerRegister);
  ...
  return (
    <div className="bg-[#12152D] h-screen flex justify-around items-center text-white overflow-hidden">
      ...
      <motion.div
        ...
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut" }}
        className="bg-[#F9EFE6] text-blue-950 p-15 w-2/5 h-[90vh] rounded-lg flex justify-center items-center flex-col"
      >
        ...
        <div className='flex justify-around gap-12 mb-6 pt-2'>
          <button
            ...
            className={`px-2 border-b-4 ${location.pathname === '/farmer-register'
          ...
          <button
            ...
            className={`px-2 border-b-4 ${location.pathname === '/supplier-register'
                ? 'border-yellow-500 text-yellow-500'
                : 'border-transparent text-gray-600 hover:text-yellow-500'
              }`}
          >
