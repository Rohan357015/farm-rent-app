...
function SupplierRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (success) navigate("/supplier-dashboard");
    } catch (error) {
      ...
      >
        ...
        >
          <div className="flex flex-col gap-4 w-full items-center">
            ...
            <input className="bg-white h-10 w-full max-w-md rounded-lg px-6" type="text" placeholder="Company Name" name="companyName" value={formData.companyName} onChange={handleChange} />
