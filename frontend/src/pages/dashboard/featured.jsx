...
export default function EquipmentBrowser() {
  ...
  return (
    <div className="w-full bg-[#F8FAF3] p-6 rounded-xl">
      ...
      {/* Search + Filter */}
      <div className="flex gap-3 items-center relative filter-container">
        <div className="flex items-center bg-white w-full p-3 rounded-xl border hover:border-green-400 transition">
